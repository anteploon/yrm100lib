...
ssize_t serial_configure(serial_port_t port)
{
    ...
    tty.c_cc[VTIME] = 3;
    tty.c_cc[VMIN] = YRM100_FRAME_MINIMUM_NOTICE_SIZE > RFID_UHF_FRAME_MINIMUM_RESPONSE_SIZE ? RFID_UHF_FRAME_MINIMUM_RESPONSE_SIZE : RFID_UHF_FRAME_MINIMUM_NOTICE_SIZE;
